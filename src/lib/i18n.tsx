...
const translations: Record<Lang, Record<string, string>> = {
  ...
  it: {
    ...
    "Select": "Seleziona",
    "Amount for": "Importo per",
    "applied": "applicata/e",
    "No recurring items for this month": "Nessuna spesa ricorrente per questo mese",
    "Apply": "Applica",
    ...
    "Apply Recurring Expenses": "Applica spese ricorrenti",
    "Apply modification from": "Applica modifica da",
    "Select all": "Seleziona tutto",
    "Loading...": "Caricamento...",
    "No recurring items": "Nessuna spesa ricorrente",
    "Applied": "Applicata",
    ...
    "Apply From": "Applica da",
    "Default apply from": "Predefinito: applica da",
